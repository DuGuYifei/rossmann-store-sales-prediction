...
y_data_b_a_train = x_data_b_a_train.pop('Sales')
y_data_b_a_test = x_data_b_a_test.pop('Sales')
...
y_data_b_b_train = x_data_b_b_train.pop('Sales')
y_data_b_b_test = x_data_b_b_test.pop('Sales')
...
y_data_b_c_train = x_data_b_c_train.pop('Sales')
y_data_b_c_test = x_data_b_c_test.pop('Sales')

#data_c_a
x_data_c_a_train, x_data_c_a_test = train_test_split(data_c_a, test_size=0.02, random_state=10)
x_data_c_a_train.reset_index(drop=True, inplace=True)
x_data_c_a_test.reset_index(drop=True, inplace=True)
features_create(x_data_c_a_train)
features_create(x_data_c_a_test)
y_data_c_a_train = x_data_c_a_train.pop('Sales')
y_data_c_a_test = x_data_c_a_test.pop('Sales')

#data_c_c
x_data_c_c_train, x_data_c_c_test = train_test_split(data_c_c, test_size=0.02, random_state=10)
x_data_c_c_train.reset_index(drop=True, inplace=True)
x_data_c_c_test.reset_index(drop=True, inplace=True)
features_create(x_data_c_c_train)
features_create(x_data_c_c_test)
y_data_c_c_train = x_data_c_c_train.pop('Sales')
y_data_c_c_test = x_data_c_c_test.pop('Sales')

#data_d_a
x_data_d_a_train, x_data_d_a_test = train_test_split(data_d_a, test_size=0.02, random_state=10)
x_data_d_a_train.reset_index(drop=True, inplace=True)
x_data_d_a_test.reset_index(drop=True, inplace=True)
features_create(x_data_d_a_train)
features_create(x_data_d_a_test)
y_data_d_a_train = x_data_d_a_train.pop('Sales')
y_data_d_a_test = x_data_d_a_test.pop('Sales')

#data_d_c
x_data_d_c_train, x_data_d_c_test = train_test_split(data_d_c, test_size=0.02, random_state=10)
x_data_d_c_train.reset_index(drop=True, inplace=True)
x_data_d_c_test.reset_index(drop=True, inplace=True)
features_create(x_data_d_c_train)
features_create(x_data_d_c_test)
y_data_d_c_train = x_data_d_c_train.pop('Sales')
y_data_d_c_test = x_data_d_c_test.pop('Sales')
