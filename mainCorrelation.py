...
merged_sales["StoreType"] = merged_sales["StoreType"].replace(to_replace="a", value=1)
merged_sales["StoreType"] = merged_sales["StoreType"].replace(to_replace="b", value=2)
merged_sales["StoreType"] = merged_sales["StoreType"].replace(to_replace="c", value=3)
merged_sales["StoreType"] = merged_sales["StoreType"].replace(to_replace="d", value=4)
merged_sales["Assortment"] = merged_sales["Assortment"].replace(to_replace="a", value=1)
merged_sales["Assortment"] = merged_sales["Assortment"].replace(to_replace="b", value=2)
merged_sales["Assortment"] = merged_sales["Assortment"].replace(to_replace="c", value=3)

# remove data of store which didn't open
sales_treated = merged_sales.drop(index=(merged_sales[merged_sales["Open"] == 0]).index, axis=1)
...
assortment_pivot_total_sales = pd.pivot_table((sales_treated[sales_treated['Year'] < 2015]), index='Month', values='Sales', columns='Assortment', aggfunc=np.sum)
...
print(pd.pivot_table((sales_treated[sales_treated['Year'] < 2015]), index='Assortment', values='Store', aggfunc='count'))
...
storetype_pivot_total_sales = pd.pivot_table((sales_treated[sales_treated['Year'] < 2015]), index='Month', values='Sales', columns='StoreType', aggfunc=np.sum)
storetype_pivot_total_sales.plot(kind='line', title='Total Sales by Month and StoreType', figsize=(7, 8), grid=True)
plt.show()
print(pd.pivot_table((sales_treated[sales_treated['Year'] < 2015]), index='StoreType', values='Store', aggfunc='count'))

storetype_pivot_avg_sales = pd.pivot_table((sales_treated[sales_treated['Year'] < 2015]), index='Month', values='Sales', columns='StoreType', aggfunc=np.mean)
storetype_pivot_avg_sales.plot(kind='line', title='Average Sales by Month and StoreType', figsize=(7, 5), grid=True)
plt.show()
...
# Customer - store type
storetype_pivot_total_cus = pd.pivot_table((sales_treated[sales_treated['Year'] < 2015]), index='Month', values='Customers', columns='StoreType', aggfunc=np.sum)
storetype_pivot_total_cus.plot(kind='line', title='Total Customers by Month and StoreType', figsize=(7, 8), grid=True)
plt.show()

storetype_pivot_avg_sales = pd.pivot_table((sales_treated[sales_treated['Year'] < 2015]), index='Month', values='Customers', columns='StoreType', aggfunc=np.mean)
storetype_pivot_avg_sales.plot(kind='line', title='Average Customers by Month and StoreType', figsize=(7, 5), grid=True)
plt.show()
# So
...
# Customer - assortment
assortment_pivot_total_cus = pd.pivot_table((sales_treated[sales_treated['Year'] < 2015]), index='Month', values='Customers', columns='Assortment', aggfunc=np.sum)
assortment_pivot_total_cus.plot(kind='line', title='Total Customers by Month and Assortment', figsize=(7, 8), grid=True)
plt.show()

assortment_pivot_avg_sales = pd.pivot_table((sales_treated[sales_treated['Year'] < 2015]), index='Month', values='Customers', columns='Assortment', aggfunc=np.mean)
assortment_pivot_avg_sales.plot(kind='line', title='Average Customers by Month and Assortment', figsize=(7, 5), grid=True)
plt.show()
# So:
